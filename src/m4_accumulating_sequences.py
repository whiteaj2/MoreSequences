...
def run_test_make_simple_list():
    ...
    actual = make_simple_list(2, 10)
    print('Expected:', expected)
    print('Actual:  ', actual)

    expected = [10, 11, 12, 13, 14, 15, 16, 17, 18]
    actual = make_simple_list(10, 18)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    actual = make_less_simple_string(5, 12)
    print('Expected: ', expected)
    print('Actual: ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        rectangle = rg.Rectangle(rg.Point(center.x - radius, center.y - radius),
                                 rg.Point(center.x + radius, center.y + radius))
